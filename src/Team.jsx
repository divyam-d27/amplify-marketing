import member1Img from "/images/team/team-01.png";
import member2Img from "/images/team/team-02.png";
import member3Img from "/images/team/team-03.png";
      ...
      <div className="container">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div className="mb-10" data-wow-delay=".1s">
              ...
              <div className="text-center">
                <h4 className="mb-2 text-lg font-medium text-dark">John Doe</h4>
